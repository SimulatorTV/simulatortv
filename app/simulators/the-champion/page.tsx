...
const styles = {
  ...
  nominationLayout: { display: "grid", gridTemplateColumns: "repeat(8, minmax(0, 1fr))", gap: 14, width: "100%", maxWidth: 1200, margin: "20px auto", alignItems: "stretch" },
  ...
  voteGrid: { display: "grid", gridTemplateColumns: "repeat(8, minmax(0, 1fr))", gap: 12, margin: "20px auto", width: "100%" },
